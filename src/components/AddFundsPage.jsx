...
import { Plus, CreditCard, Lock, Calendar, User, DollarSign, Sparkles, ArrowRight, Wallet, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <form onSubmit={handleAddFunds} className="p-6 md:p-8 space-y-8">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h2 className="text-xl font-bold text-gray-900">Choose Amount</h2>
              </div>
        ...
        <div className="grid grid-cols-3 gap-4 mt-8">
          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div className="text-2xl mb-2">⚡</div>
            <p className="text-sm text-gray-600 font-medium">Instant Transfer</p>
          </div>
          <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div className="text-2xl mb-2">✓</div>
