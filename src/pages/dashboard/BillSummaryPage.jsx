...
const BillSummaryPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-10">
          ...
          <div className="p-8 space-y-4">
            {splits.map(split => <div key={split.id} className="flex items-center justify-between p-6 bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-100 hover:shadow-md hover:border-emerald-200 transition-all">
                <div className="flex items-center space-x-4">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shadow-sm ₦{
                    ...
                    {split.type === 'owes' ? <ArrowRight className="w-6 h-6 text-orange-600" /> : <CheckCircle className="w-6 h-6 text-emerald-600" />}
                  </div>
                  <div>
                    {split.type === 'owes' ? <p className="text-gray-900 font-semibold text-lg">
                        {split.from} owes {split.to}
                      </p> : <p className="text-gray-900 font-semibold text-lg">
