        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-full max-w-4xl relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=1200&h=800&fit=crop" alt="Friends enjoying together" className="w-full h-auto object-cover" />
            ...
            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-4 animate-bounce hidden md:block" style={{
            animationDelay: '1s'
          }}>
              <div className="flex items-center space-x-3">
